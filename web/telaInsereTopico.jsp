                    ...
                    <div style="padding-top: 30%;">
                        ...
                        <div class="form-group" style="background-color:#124989; padding:10px;">
                            ...
                            <form class="center-block" method="post" action="criarTopico">
                                ...
                                <input type="text" name="titulo" placeholder="Título do Tópico" class="form-control text-center" />
                                ​<textarea id="conteudo" rows="10" cols="70" name="conteudo" placeholder="Conteúdo do tópico" class="form-control text-center"></textarea>
